...
(function(T, V, s) {
	...
	function Ba(b, a, c, d) {
		...
		if(a) {
			...
			if(A(b))
				for(var f = a.length = 0; f < b.length; f++) e = Ba(b[f], null, c, d), J(b[f]) && (c.push(b[f]),
					d.push(e)), a.push(e);
			else {
				var g = a.$$hashKey;
	...
	function Nd(b, a) {
		...
		b = G(b);
		for(d = 0; d < e; ++d)
			if(c = tb[d] + a, K(c = b.attr(c))) return c;
		return null
	}
	...
	function sf(b, a, c, d) {
		...
		m.cookies = function(a, b) {
			var d, e, f, g;
			if(a) b === s ? r.cookie = encodeURIComponent(a) + "=;path=" + hb + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : K(b) && (d = (r.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + hb).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
			else {
				if(r.cookie !== B)
					for(B = r.cookie, d = B.split("; "), Fa = {}, f = 0; f < d.length; f++) e =
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, d, u, p, I, R, x, M, C) {
			...
			function X(a, b, c, d, e, f) {
				function g(a, c, d, e) {
					var f, l, k, n, m, t, w;
					if(p)
						for(w = Array(c.length), n = 0; n < h.length; n += 3) f = h[n], w[f] = c[f];
					else w = c;
					n = 0;
			...
			function W(a, b, c, d, e) {
				...
				switch(a.nodeType) {
					case ma:
						...
						J(a) && (a = a.animVal);
						if(K(a) && "" !== a)
							for(; l = g.exec(a);) k = va(l[2]), z(b, k, "C", d, e) && (c[k] = N(l[3])), a = a.substr(l.index + l[0].length);
						break;
					case ab:
						ia(b, a.nodeValue);
						break;
			...
			function B(a, d, e, f, g, h, k, n, m) {
				...
				for(var C = -Number.MAX_VALUE, H, I = m.controllerDirectives, $, R = m.newIsolateScopeDirective, X = m.templateDirective,
					...
					if(E = L.transclude) z = !0, L.$$tlb || (Oa("transclusion", Ga, L, y), Ga = L),
						"element" == E ? (D = !0, C = L.priority, E = y, y = e.$$element = G(V.createComment(" " + ia + ": " + e[ia] + " ")), d = y[0], U(g, Za.call(E, 0), d), gb = Q(E, f, C, h && h.name, {
							nonTlbTranscludeDirective: Ga
						})) : (E = G(Vb(d)).contents(), y.empty(), gb = Q(E, f));
					if(L.template)
						if(Yb = !0, Oa("template", X, L, y), X = L, E = F(L.template) ? L.template(y, e) : L.template, E = Yc(E), L.replace) {
							h = L;
			...
			function Xb(a, b, c, e, f, g,
				...
				var l = [],
					...
					M = F(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl,
					v = t.templateNamespace;
				b.empty();
				d(M).then(function(d) {
					var w, C;
					d = Yc(d);
			...
			$b.prototype = {
				...
				$set: function(a, b, d, e) {
					...
					g = sa(this.$$element);
					if("a" === g && "href" === a || "img" ===
						g && "src" === a) this[a] = b = C(b, "src" === a);
					else if("img" === g && "srcset" === a) {
						for(var g = "", h = N(b), l = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = /\s/.test(h) ? l : /(,)/, h = h.split(l), l = Math.floor(h.length / 2), k = 0; k < l; k++) var n = 2 * k,
							g = g + C(N(h[n]), !0),
							g = g + (" " + N(h[n + 1]));
						h = N(h[2 * k]).split(/\s/);
						g += C(N(h[0]), !0);
	...
	function Af(b, a, c, d, e) {
		function f(a, b, c) {
			...
			m = function(a) {
				...
				a && ("load" !== a.type || d[b].called || (a = {
					type: "error"
				}), v = a.type, g = "error" === a.type ? 404 : 200);
				c && c(g, v)
			};
		...
		return function(e, h, l, k, m, r, n, v) {
			...
			if("jsonp" == O(e)) {
				...
				I.onload = function() {
					var a = I.statusText || "",
						b = "response" in I ? I.response : I.responseText,
						c = 1223 === I.status ? 204 : I.status;
	...
	function Ne() {
		...
		this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
			...
			function g(f, g, v, t) {
				...
				t = !!t;
				for(var p, I, q = 0, x = [], M = [], C = f.length, H = [], Q = []; q < C;)
					if(-1 != (p = f.indexOf(b, q)) && -1 != (I = f.indexOf(a, p + h))) q !== p && H.push(w(f.substring(q, p))), q = f.substring(p + h, I), x.push(q), M.push(c(q, u)), q = I + l, Q.push(H.length), H.push("");
					else {
				...
				$watchCollection: function(a, b) {
					function c(a) {
						...
						if(!z(e)) {
							if(J(e))
								if(Sa(e))
									for(f !== n && (f = n, v = f.length = 0, k++), a = e.length, v !== a && (k++, f.length = v = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
								else {
									f !== r && (f = r = {}, v = 0, k++);
									a = 0;
									for(b in e) e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (v++, f[b] = g, k++));
									if(v > a)
										for(b in k++, f) e.hasOwnProperty(b) || (v--, delete f[b])
								}
							else f !== e && (f = e, k++);
							return k
						}
						...
						a: do {
							if(k = w.$$watchers)
								for(m = k.length; m--;) try {
									if(b = k[m])
										if((f = b.get(w)) !== (h = b.last) &&
											!(b.eq ? fa(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h))) n = !0, d = b, b.last = b.eq ? Ba(f, null) : f, b.fn(f, h === v ? f : h, w), 5 > q && (s = 4 - q, S[s] || (S[s] = []), S[s].push({
							...
							if(!(k = w.$$childHead || w !== this && w.$$nextSibling))
								for(; w !== this && !(k = w.$$nextSibling);) w = w.$parent
						} while (w = k);
	...
	function Ze() {
		this.$get = ["$window", "$document", function(b, a) {
			var c = {},
				d = aa((/android (\d+)/.exec(O((b.navigator || {}).userAgent)) || [])[1]),
	...
	function Ha(b, a, c, d, e) {
		...
		switch(f) {
			case "object":
				...
				if("object" === g) {
					for(h in a)
						if(e = a[h], !F(e) && !z(e) && (f = "$" === h, !Ha(f ? b : b[h], e, c, f, f))) return !1;
					return !0
				}
				return c(b, a);
			case "function":
	...
	function sd(b, a, c, d, e) {
		...
		if(k) 0 < e && 1 > b && (h = b.toFixed(e), b = parseFloat(h));
			...
			var g = ("" + b).split(td),
				...
				v = a.gSize;
			if(k.length >= n + v)
				for(r = k.length - n, m = 0; m < r; m++) 0 === (r - m) % v && 0 !== m && (h += c), h += k.charAt(m);
	...
	function nb(b, a, c, d) {
		return function(e, f, g, h, l, k, m) {
			...
			yd(e, f, g, h);
			mb(e, f, g, h, l, k);
			var v = h && h.$options && h.$options.timezone,
				t;
			h.$$parserName = b;
			...
			search: function(a, c) {
				switch(arguments.length) {
					case 0:
						return this.$$search;
					case 1:
						if(K(a) || U(a)) a = a.toString(), this.$$search = vc(a);
						else if(J(a)) a = Ba(a, {}), q(a, function(c, e) {
							null == c && delete a[e]
						}), this.$$search = a;
	...
	var ne = ["$animate", function(a) {
		...
		ig = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, g, h, l, k, m) {
			...
			var I = e.inheritedData("$formController") || Lb,
				E = 0;
			xd({
				ctrl: this,
				$element: e,
				...
				function(a, c, d) {
					...
					(function() {
						var a =
							p.$$parserName || "parse";
						if(u === s) g(a, null);
						else return u || (q(p.$validators, function(a, c) {
							g(c, null)
				...
				compile: function(f, g) {
					...
					return function(a, f, g, k, m) {
						...
						a.$watchCollection(r, function(g) {
							...
							J = Array(y);
							for(k = 0; k < y; k++)
								if(D = g === F ? k : F[k], Q = g[D], x = r(D, Q, k), v[x]) A = v[x], delete v[x], z[x] = A, J[k] = A;
								else {
							...
							for(H in v) {
								...
								c.leave(x);
								if(x[0].parentNode)
									for(k = 0, r = x.length; k < r; k++) x[k].$$NG_REMOVED = !0;
								A.scope.$destroy()
							}
							for(k = 0; k < y; k++)
								if(D = g === F ? k : F[k], Q = g[D], A = J[k], A.scope) {
									H = u;
				...
				link: function(e, g, h, l) {
					...
					function r(e, f, g) {
						...
						e.$watchCollection(function() {
							...
							if(a && A(a)) {
								...
								for(d in c = {}, a) a.hasOwnProperty(d) && (c[d] = h(y, d, a[d]));
							return c
						}, l);
					...
					if(l[1]) {
						...
						var v = h.multiple,
							...
							w = !1,
							u, p = !1,
							z = G(V.createElement("option")),
							E = G(V.createElement("optgroup")),
							y = z.clone();
						h = 0;
						for(var D = g.children(), F = D.length; h < F; h++)
							if("" === D[h].value) {
								u = w = D.eq(h);
								break
							}
